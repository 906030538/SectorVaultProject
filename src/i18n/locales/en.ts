...
'auth.title': 'Authorize & sign in',
  ...
  'collection.mirrorsLabel': 'Mirror repos (host/owner/repo)',
  'collection.mirrorsPh': 'e.g. gitee.com/user/repo, Enter or Add',
  'collection.mirrorsInvalid': 'Address must be a supported git platform (github/gitee/atomgit/gitcode.com/owner/repo)',
  'collection.mirrorsAdd': 'Add',
...
'detail.commentsDisabled': 'Comments are disabled',
  ...
  'editor.songLanguages': 'Song languages (incl. dialects, codes per ISO 639-3)',
  'editor.add': 'Add',
