const zhHans = {
  ...
  'nav.about': '网站介绍',
  'nav.login': '登录',
  'ratelimit.title': '接口配额已用尽',
  'ratelimit.hint': '登录该平台账号可提高配额，或在导航栏切换其他线路',
  'nav.logout': '登出',
  'nav.submit': '投稿',
  'nav.menu': '菜单',
  'nav.more': '更多',
...
'auth.title': '授权登录',
  ...
  'auth.oauthUnavailable': '该平台未配置 OAuth，请使用令牌登录',
  ...
  'collection.mirrorsLabel': '镜像仓库（域名/属主/仓库）',
  'collection.mirrorsPh': '如 gitee.com/user/repo，回车或添加',
  'collection.mirrorsInvalid': '地址需为支持的 git 平台（github/gitee/atomgit/gitcode.com/属主/仓库）',
  'collection.mirrorsAdd': '添加',
...
'detail.commentsDisabled': '评论区已禁用',
  ...
  'discussions.newDiscussion': '新建讨论',
  'discussions.newDiscussionTitle': '新建讨论',
  'discussions.newDiscussionTarget': '目标仓库',
  'discussions.fieldTitle': '标题',
  'discussions.fieldCategory': '分类',
  'discussions.fieldBody': '内容',
  'discussions.newDiscussionSubmit': '发布',
  'discussions.errTitle': '请输入标题',
  'discussions.errBody': '请输入内容',
  'discussions.createFailed': '创建失败',
  'discussions.loginFirst': '请先登录目标平台',
  ...
  'user.owner': '属主',
  'user.template': '模板库',
  'user.templateNone': '不使用（仅必要文件）',
  'user.license': '默认许可证',
  'user.licenseNone': '不设置',
  'user.licenseCustom': '自定义',
  'user.licenseCustomPh': '输入自定义许可证全文',
  'user.licenseCustomRequired': '请输入自定义许可证内容',
  'user.create': '创建',
  'user.creating': '创建中…',
  'user.created': '仓库创建请求已提交',
  'user.createFailed': '创建失败，请检查令牌与权限',
  ...
  'editor.videos': '视频站链接',
  'editor.songLanguages': '歌曲语言（含方言，代码参考 ISO 639-3）',
  'editor.add': '添加',
  'editor.remove': '删除',
  ...
  'editor.attachmentsGithubHint': '当前平台不支持外部上传，请跳转平台页面去上传附件',
  'editor.attachmentsGithubSummaryHint': '当前平台不支持外部上传，请在发布稿件后，前往平台页面上传附件',
