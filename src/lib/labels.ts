...
export function buildCollectionLabels(locale: Locale): CollectionLabels {
  return {
    ...
    mirrorsLabel: t(locale, 'collection.mirrorsLabel'),
    mirrorsPh: t(locale, 'collection.mirrorsPh'),
    mirrorsInvalid: t(locale, 'collection.mirrorsInvalid'),
    mirrorsAdd: t(locale, 'collection.mirrorsAdd'),
...
export function buildDetailLabels(locale: Locale): DetailLabels {
  return {
    ...
    commentsClosed: t(locale, 'detail.commentsClosed'),
    noComments: t(locale, 'detail.noComments'),
    viewIssue: t(locale, 'detail.viewIssue'),
    issueReopen: t(locale, 'detail.issueReopen'),
    issueClose: t(locale, 'detail.issueClose'),
